...
namespace msb
{
    public class Program
    {
        public static int Main(string[] args)
        {
            ...
            var fileName = envName == "Production" ? "D:/Logs/msB/msb.prod.log"
                            : (envName == "Staging" ? "D:/Logs/msB/msb.staging.log"
                            : (envName == "Development" ? "D:/Logs/msB/msb.devl.log"
                            : "S:/Logs/msb/msb.local.log"));
